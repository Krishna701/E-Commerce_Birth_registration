...
namespace EGovProject.Controllers
{
    public class BirthController : Controller
    {
        ...
        [HttpGet]
        public IActionResult Edit(string registrationNumber)
        {
        ...
        public IActionResult BirthCertificate(int birthId)
        {
        ...
        public IActionResult BirthCertificateIndex(int birthId)
        {
